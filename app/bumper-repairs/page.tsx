...
export const metadata: Metadata = {
  title: 'Bumper Repair | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile bumper scuff, scrape and crack repair across South East Melbourne.',
  robots: { index: false, follow: true },
}

export default function BumperRepairsPage() {
  return (
    <main className="min-h-[60vh] max-w-7xl mx-auto px-5 py-24">
      ...
      <p className="text-neutral-muted mt-4 max-w-[40em] text-[17px] leading-relaxed">
        {/* TODO: page intro — plastic bumper scuffs, scrapes, cracks; done at your place */}
      </p>
