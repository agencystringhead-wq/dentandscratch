...
export const metadata: Metadata = {
  title: 'Mobile Car Repairs — Greater Dandenong & Monash | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile dent, scratch and bumper repair in Dandenong, Glen Waverley, Clayton and surrounds.',
  robots: { index: false, follow: true },
}

const SUBURBS = [
  'Dandenong', 'Dandenong South', 'Springvale', 'Springvale South', 'Noble Park',
  'Keysborough', 'Glen Waverley', 'Mount Waverley', 'Mulgrave', 'Clayton',
  'Clayton South', 'Oakleigh', 'Oakleigh South', 'Chadstone',
]

export default function DandenongMonashPage() {
  return (
