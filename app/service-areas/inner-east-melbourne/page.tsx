...
export const metadata: Metadata = {
  title: 'Mobile Car Repairs — Inner East Melbourne | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile dent and scratch repair in Hawthorn, Camberwell, Box Hill, Doncaster and Inner East Melbourne.',
  robots: { index: false, follow: true },
}

const SUBURBS = [
  'Hawthorn', 'Kew', 'Camberwell', 'Canterbury', 'Balwyn', 'Balwyn North',
  'Glen Iris', 'Burwood', 'Box Hill', 'Blackburn', 'Mitcham',
  'Doncaster', 'Donvale', 'Bulleen', 'Templestowe',
]

export default function InnerEastMelbournePage() {
  return (
