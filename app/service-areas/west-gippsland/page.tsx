...
// TODO: Confirm with Diarmuid that West Gippsland (Drouin, Warragul etc.) is genuinely serviced before go-live
export const metadata: Metadata = {
  title: 'Mobile Car Repairs — West Gippsland | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile dent and scratch repair in Drouin, Warragul and West Gippsland.',
  robots: { index: false, follow: true },
}

const SUBURBS = [
  'Drouin', 'Warragul', 'Longwarry', 'Tynong', 'Buln Buln', 'Nar Nar Goon', 'Garfield',
]

export default function WestGippslandPage() {
  return (
    <main className="min-h-[60vh] max-w-7xl mx-auto px-5 py-24">
      ...
      <p className="text-neutral-muted mt-4 max-w-[40em] text-[17px] leading-relaxed">
        {/* TODO: zone intro — travel note, minimum job size for this distance */}
      </p>
