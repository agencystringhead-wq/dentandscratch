...
export const metadata: Metadata = {
  title: 'Mobile Car Repairs — Frankston & Mornington Peninsula | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile dent and scratch repair in Frankston, Mornington, Seaford and the Mornington Peninsula.',
  robots: { index: false, follow: true },
}

const SUBURBS = [
  'Frankston', 'Frankston North', 'Carrum Downs', 'Seaford', 'Patterson Lakes',
  'Aspendale Gardens', 'Mount Eliza', 'Mornington', 'Mount Martha', 'Moorooduc', 'Bittern',
]
  ...
  return (
    <main className="min-h-[60vh] max-w-7xl mx-auto px-5 py-24">
      ...
      <p className="text-neutral-muted mt-4 max-w-[40em] text-[17px] leading-relaxed">
        {/* TODO: zone intro — real local detail, travel note */}
      </p>
