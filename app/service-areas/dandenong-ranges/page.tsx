...
export const metadata: Metadata = {
  title: 'Mobile Car Repairs — Dandenong Ranges | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile dent and scratch repair in Belgrave, Olinda, Upwey and the Dandenong Ranges.',
  robots: { index: false, follow: true },
}

const SUBURBS = [
  'Belgrave', 'Olinda', 'Sassafras', 'Sherbrooke', 'Monbulk',
  'Kallista', 'Silvan', 'Menzies Creek', 'Cockatoo', 'Gembrook',
  'Upwey', 'The Basin', 'Ferny Creek',
]

export default function DandenongRangesPage() {
  return (
    <main className="min-h-[60vh] max-w-7xl mx-auto px-5 py-24">
      ...
      <p className="text-neutral-muted mt-4 max-w-[40em] text-[17px] leading-relaxed">
        {/* TODO: zone intro — real local detail, ranges context, travel note */}
      </p>
