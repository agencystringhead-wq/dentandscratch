...
export const metadata: Metadata = {
  title: 'Plastic Repair | Dent & Scratch Direct',
  description: 'TODO: meta description — mobile plastic trim and panel repair across South East Melbourne.',
  robots: { index: false, follow: true },
}

export default function PlasticRepairsPage() {
  return (
    <main className="min-h-[60vh] max-w-7xl mx-auto px-5 py-24">
      ...
      <p className="text-neutral-muted mt-4 max-w-[40em] text-[17px] leading-relaxed">
        {/* TODO: page intro — plastic trim, wheel arch, side skirt, interior repair */}
      </p>
